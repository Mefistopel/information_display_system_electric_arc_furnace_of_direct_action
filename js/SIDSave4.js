     ...
     if (len == true) {
      ...
      window.proviso = 1; window.even = true;
       if (OneOn == 1) { //чтобы нельзя было запустить при работающей функции
         ObjectMettal();
         setTimeout(function(){FuncIron(90.5);FuncAluminum(0);FuncPhosphorus(0);FuncSulfur(0.008);FuncManganese(0);FuncSilicon(0);FuncCarbon(1.2);}, 1550);
       }
